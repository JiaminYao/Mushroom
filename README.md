...
- Free-form drawing canvas with color picker, brush sizes, and eraser
- A shared meadow where all mushrooms live together
- Community voting system with live scores
- Leaderboard ranked by score, recency, or random discovery
...
Visit: **[mushroom.jiaminyao.workers.dev](https://mushroom.jiaminyao.workers.dev)**
